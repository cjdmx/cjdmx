...
//	email :	fuushikaden@yahoo.com
	...
	var imgDir = "images/date/images"			// directory for images ... e.g. var imgDir="/img/"
...
//               alert(imgDir);
//               imgDir=model + "/images/date/images/";
//               alert(imgDir);
		var	leftpos=0
		var	toppos=0
		if (bPageLoaded)
		{
			...
			if ( crossobj.visibility ==	"hidden" ) {
				...
				} while(aTag.tagName!="BODY" && aTag.id!="divContent");
