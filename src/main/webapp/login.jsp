...
<table width="100%" height="166" border="0" cellpadding="0" cellspacing="0">
        ...
        <td valign="top"><table width="100%" height="532" border="0" cellpadding="0" cellspacing="0" class="login_bg">
            <tr>
                        ...
                        <td height="138" valign="top"><table width="89%" height="427" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td height="198" align="right" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="35%">&nbsp;</td>
                                        <td height="25" colspan="2" class="left_txt"><p>1- 济南地区医院信息网门户站建立的首选医院...</p></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                ...
                <td width="50%" valign="bottom"><table width="100%" height="59" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="4%">&nbsp;</td>
                        <td width="96%" height="38"><span class="login_txt_bt">济南中心医院登录页面</span></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                                    ...
                                    <form  action="/user/login.action" method="post">
                                        <table cellSpacing="0" cellPadding="0" width="100%" border="0" height="143" id="table212">
                                            ...
                                            <tr>
                                                ...
                                                <td width="40%" class="top_hui_text"><input name="cs" type="reset" class="button" id="cs" value="取 消" onclick="showConfirmMsg1()"></td>
                                                <td width="40%"><a href="patient/userRegister.jsp"><font color="red">患者注册入口...</font></a></td>
                                            </tr>
                                        </table>
                                        <br>
                                    </form>
    ...
    <tr>
        <%--<td height="20"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="login-buttom-bg">
            <tr>
                <td align="center"><span class="login-buttom-txt">Copyright &copy; 20017-2018 www.865171.cn</span></td>
            </tr>
        </table></td>--%>
